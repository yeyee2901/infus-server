...
def insertBLOB (bad_id, volume_infus_1, volume_infus_2, photo):
        ...
        try:
                ...
                insert_blob_tuple = (bad_id, volume_infus_1, volume_infus_2, infusPicture)
...
def selisih():
        ...
        def volume_input1():
                ...
                if volume_infus1==450 or volume_infus1==400 or volume_infus1==350 or volume_infus1==300 or volume_infus1==250 or volume_infus1==200 or volume_infus1==150 or volume_infus1== 100 or volume_infus1==50:
                        ...
                        output = ("/home/pi/Pictures/Image_Bed1.jpg")
                        sleep (0.5)
                ...
                hasil1.after(100, volume_input1)
        ...
        def volume_input2():
                ...
                volume_infus_1 = str (volume_infus1)
                volume_infus_2 = str (volume_infus2)
                
                insertBLOB("bed 1",volume_infus_1, volume_infus_2, "/home/pi/Pictures/Image_Bed1.jpg")

                hasil2.configure(text=volume_infus2)
                hasil2.after(100, volume_input2)
