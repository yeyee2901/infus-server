...
def input_infus1():
        nilai_awal1 = 500
        infus1Button["text"] = "infus 1 500 mL"
        print ("Volume Infus 1 500 mL")

def input_infus2():
        nilai_awal2 = 500
        infus2Button["text"] = "infus 2 500 mL"
...
infus1Button = tk.Button(win, text = "infus 1 500 mL", font = myFont, command = input_infus1, heigh = 2,width = 8)
infus1Button.pack()

infus2Button = tk.Button(win, text = "infus 2 500 mL", font = myFont, command = input_infus2, heigh = 2,width = 8)
infus2Button.pack()
